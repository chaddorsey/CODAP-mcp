...
async function sendMessage(action: string, resource: string, values?: any): Promise<CODAPResponse> {
...
export const TOTAL_TOOL_COUNT = allCODAPTools.length;

console.log(`✅ CODAP Tools Module Loaded: ${TOTAL_TOOL_COUNT} tools available`);