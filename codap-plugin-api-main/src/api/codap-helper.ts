...
export const createSingleOrParentCase = (dataContextName: string, collectionName: string, values: CodapItemValues[]) => {
...
export const selectCases = (dataContextName: string, caseIds: (string|number)[]) => {
  return sendMessage("create", `${ctxStr(dataContextName)}.selectionList`, caseIds);
};

export const addCasesToSelection = (dataContextName: string, caseIds: (string|number)[]) => {
...
export const createItems = (dataContextName: string, items: CodapItemValues[]) => {
