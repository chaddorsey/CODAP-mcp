...
type CodapItemValues = Record<string, any>;
interface CodapItem {
    id: number | string;
...
declare const createSingleOrParentCase: (dataContextName: string, collectionName: string, values: CodapItemValues[]) => Promise<IResult>;
...
declare const selectCases: (dataContextName: string, caseIds: (string | number)[]) => Promise<IResult>;
declare const addCasesToSelection: (dataContextName: string, caseIds: (string | number)[]) => Promise<IResult>;
...
declare const createItems: (dataContextName: string, items: CodapItemValues[]) => Promise<IResult>;
